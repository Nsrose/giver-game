...
<<<<<<< HEAD
    if (!self.expiration_time.nil? && self.expiration_time < DateTime.now)
       errors.add("Expiration Date", "can not be in the past make sure date was formatted MM/DD/YYYY") 
=======
...
>>>>>>> 7e6c15e81be3ca2c21d8ed87640ba316bf37caf0
    end
  end
